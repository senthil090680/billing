										...
										else
										{
											...
											else
											{
												...
												else
												{
													...
													{
														$query2 = "insert into master_customer (customercode, customername, address1, address2, area, city, state,	pincode) 
														values ('$customercode', '$customername', '$address1', '$address2', '$area', '$city', '$state', '$pincode')";
            ...
            <tr>
              <td>
                  <table width="83%" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Customer Data Import From TAB Delimited File </strong></td>
                      </tr>
                      <tr>
