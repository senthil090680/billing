...
if ($frmflag1 == 'frmflag1')
{
	...
	$query3 = "select auto_number from settings_deliverychallanout where companyanum = '$companyanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
	$rowcount3 = mysql_num_rows($exec3);
	if ($rowcount3 != 0)
	{
		$query1 = "update settings_deliverychallanout set f1 = '$f1', f2 = '$f2', f3 = '$f3', f4 = '$f4', f5 = '$f5', 
	...
	{
		$query4 = "insert into settings_deliverychallanout (f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, 
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" action="settingsdeliverychallan1out.php" enctype="multipart/form-data">
