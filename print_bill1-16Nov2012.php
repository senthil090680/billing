...
<table width="660" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3"><span class="style6"><?php echo 'Total Items : '.round($totalquantity, 4); ?></span></td>
  </tr>
  <?phpphp
  if ($billremarks != '')
  {
  ?>
  <tr>
    <td colspan="3"><span class="style6"><?php echo 'Remarks : '.$billremarks; ?></span></td>
  </tr>
  <?phpphp
  }
  ?>
  <tr>
    <td colspan="3"><span class="style6"><?php echo $f31; ?></span></td>
  </tr>
  <tr>
    <td colspan="3"><span class="style6"><?php echo $f32; ?></span></td>
  </tr>
  <tr>
    <td colspan="3"><div class="style27"><span class="style6"><?php echo $f23; ?></span></div></td>
  </tr>
  <tr>
