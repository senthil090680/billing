...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (isset($_REQUEST["delbillst"])) { $delBillSt = $_REQUEST["delbillstst"]; } else { $delBillSt = ""; }
	//$delBillSt = $_REQUEST["delbillst"];
	if (isset($_REQUEST["delbillautonumber"])) { $delBillAutonumber = $_REQUEST["delbillautonumber"]; } else { $delBillAutonumber = ""; }
	//$delBillAutonumber = $_REQUEST["delbillautonumber"];
	if (isset($_REQUEST["delbillnumber"])) { $delBillNumber = $_REQUEST["delbillnumber"]; } else { $delBillNumber = ""; }
...
<form name="frmsales" id="frmsales" method="post" action="sales1.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Sales Bill   </strong></td>
	...
	//$delBillSt = $_REQUEST["delbillst"];
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input name="customertin" id="customertin" value="<?php echo $res41tinnumber; ?>" style="border: 1px solid #001E6A"  size="12" />
			    </strong></span></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input name="customercst" id="customercst" value="<?php echo $res41cstnumber; ?>" style="border: 1px solid #001E6A"  size="12" />
			    </strong></span></td>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('sales_edit1listing1.php');
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            <tr>
			  ...
			  <input type="text" value="<?php echo $itemcount + 1; ?>" name="itemserialnumber" id="itemserialnumber" style="border: 1px solid #001E6A; text-align:left" size="1" readonly="readonly" /></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="foo">
              ...
              <tr>
                ...
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Sub Total Amount Discount Percent Apply </strong></span></div></td>
				    <td><span class="bodytext311"><strong>
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="25%"><span class="bodytext312">
                      <input name="totaltaxsubamount<?php echo $res5anum; ?><?php echo $res6loopcount; ?>" id="totaltaxsubamount<?php echo $res6loopcount; ?>" value="0.00" style="border: 1px solid #001E6A; text-align:right" onKeyDown="return disableEnterKey()" size="8"  readonly="readonly" />
                    </span></td>
                  </tr>
				<?php
				}
