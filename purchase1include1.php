	...
	*/
	...
	for ($i=1;$i<=1000;$i++)
	{
		...
		if ($serialnumber != '')
		{
			...
			'BY PURCHASE (BILL NO: $billnumber )', '$billautonumber', '$billnumber', '$itemquantity', '$remarks', 
			...
			if ($itemcode != '')
			{
				...
				updatedate, companyanum, companyname, amountbeforetax) 
				...
				'$amountaftertax', '$ipaddress', '$updatedatetime', '$companyanum', '$companyname', '$itemtotalamount')";
				$exec7 = mysql_query($query7) or die ("Error in Query7".mysql_error());
			}
