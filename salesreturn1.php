...
$query88 = "select count(auto_number) as cntanum from master_salesreturn";// where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	if ($delbillst == 'billedit' && $delbillnumber != '')
	{
		...
		$query19 = "select auto_number,lastupdate from master_salesreturn where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query15 = "update master_salesreturn set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			...
			$query16 = "update salesreturn_details set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			...
			$query17 = "update salesreturn_tax set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
...
if ($delbillst == 'billedit' && $delbillnumber != '')
{
	$query41 = "select * from master_salesreturn where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (varDefaultTax != "")
	{
		window.location="salesreturn1.php?defaulttax="+varDefaultTax+"";
	}
	else
	{
		window.location="salesreturn1.php";
	}
	//return false;
}
...
<form name="frmsales" id="frmsales" method="post" action="salesreturn1.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>SalesReturn  </strong></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" ><input name="city1" id="city1" value="<?php echo $res41city; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="10" /> 
			       <strong class="style4">Pincode</strong> <input name="pincode" id="pincode" value="<?php echo $res41pincode; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="10" /></td>
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Amount </strong></div></td>
              ...
              <tr id="cashamounttr2">
                <td colspan="7" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Enter Cash Returned To Customer </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
