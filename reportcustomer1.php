...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	else
	{
		...
		$query1 = "select * from master_customer where customername = '$customername'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		$res1 = mysql_fetch_array($exec1);
		$customeranum = $res1['auto_number'];
		$customercode = $res1['customercode'];
            ...
            <tr>
              ...
              <td colspan="6" bgcolor="#cccccc" class="bodytext31">
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
					...
					//$urlpath = "customercode=$customercode&&cbcustomername=$cbcustomername&&cbbillnumber=$cbbillnumber&&cbbillstatus=$cbbillstatus&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&financialyear=$financialyear&&companyanum=$companyanum";//&&companyname=$companyname";
					$urlpath = "customercode=$customercode&&&&cbbillnumber=$cbbillnumber&&cbbillstatus=$cbbillstatus&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&financialyear=$financialyear&&companyanum=$companyanum";//&&companyname=$companyname";
				}
				else
				{
					//$urlpath = "customercode=$customercode&&cbcustomername=$cbcustomername&&cbbillnumber=$cbbillnumber&&cbbillstatus=$cbbillstatus&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&financialyear=$financialyear&&companyanum=$companyanum";//&&companyname=$companyname";
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" /></td>
              ...
              <td width="16%" bgcolor="#cccccc" class="bodytext31"><div align="right"><strong><?php echo number_format($openingbalance, 2, '.', '') ?></strong></div></td>
            </tr>
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
			...
			//transactiondate between '$transactiondatefrom' and '$transactiondateto' and supplieranum = '0' and suppliername = '' 
			...
			supplieranum = '0' and suppliername = '' and companyanum = '$companyanum' and recordstatus <> 'DELETED' and 
			transactiondate between '$transactiondatefrom' and '$transactiondateto' order by transactiondate";// desc";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($openingbalance, 2, '.', ''); ?></div></td>
            </tr>
			<?php
			}
			}
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc">&nbsp;</td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong>Closing Balance </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo number_format($openingbalance, 2, '.', ''); ?></strong></div></td>
            </tr>
          </tbody>
        </table>
<?php
