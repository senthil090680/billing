...
$query3 = "select * from master_salesreturn where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum'";
...
<?php
$serialnumber = "";
$query4 = "select * from salesreturn_details where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum'";
...
?>
<?php
$query41 = "select *, sum(taxamount) as sumtaxamount from salesreturn_tax  where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' group by tax_autonumber, taxname order by auto_number";
