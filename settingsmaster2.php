...
if (isset($_REQUEST["salesamountinwordssettings1settings1"])) { $salesamountinwordssettings1settings1 = $_REQUEST["salesamountinwordssettings1settings1"]; } else { $salesamountinwordssettings1settings1 = ""; }
//$salesstockupdatesettings1 = $_REQUEST['salesstockupdatesettings1'];
if ($salesamountinwordssettings1settings1 == 'salesamountinwordssettings1settings1')
{
	$query2 = "update master_settings set settingsvalue = '$settingsvalue', ipaddress = '$ipaddress', username = '$username' 
	where modulename = 'SALES' and settingsname = 'AMOUNT_IN_WORDS_SALES_PRINT_SETTING' 
	and companyanum = '$companyanum' and companycode = '$companycode'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	header ("location:settingsmaster1.php?errno=1&&errmodule=salesamountinwordssettings1settings1");
}
