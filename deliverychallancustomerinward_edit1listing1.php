...
{
//echo 'inside if';
$query41 = "select * from dccustomerinward_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
$query42 = "select * from dccustomerinward_tax where itemcode = '$varItemCode' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
