...
$query88 = "select count(auto_number) as cntanum from master_dcsupplieroutward where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		$query19 = "select auto_number,lastupdate from master_dcsupplieroutward where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query15 = "update master_dcsupplieroutward set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			$query16 = "update dcsupplieroutward_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			$query17 = "update dcsupplieroutward_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
...
include ("deliverychallansupplier1outwardinclude1.php"); //handles all the purchase insert operations
...
{
	$query41 = "select * from master_dcsupplieroutward where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
<form name="frmpurchase" id="frmpurchase" method="post" action="deliverychallansupplier1outward.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>DC Outward Supplier  </strong></td>
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Prefix
				  ...
				  ?>
                  <input name="billnumber" id="billnumber" value="<?php echo $billnumber; ?>" <?php //if ($delbillst == '') { echo 'onBlur="return billvalidation()"'; } else { echo 'readonly="readonly"'; } ?> readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="8" /> 
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('deliverychallansupplieroutward_edit1listing1.php');
...
bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
                ...
                <td align="left" valign="middle" ><select name="billtype" id="billtype" onChange="return paymentinfo()">
                  ...
                  <option value="DC">DC SUPPLIER OUT</option>
