...
if ($frmflag1 == 'frmflag1')
{
	...
	$final_filename=$username."_tabdumpsupplier.txt";
	...
	if ($fileformat == 'txt') // || $fileformat == 'peg') // || $fileformat == 'gif')
	{
		...
		{
			header ("location:dataimport2updatesupplier.php?upload=success");
		}
		else
		{
			header ("location:dataimport1updatesupplier.php?upload=failed");
		}
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form action="dataimport1updatesupplier.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return dataimport1verify()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Supplier Data Update From TAB Delimited File </strong></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><a href="tab_file_dump/sample_import_file1supplier.xls" class="bodytext3"><span class="bodytext3"><strong>Sample Download File Click Here...</strong></span></a></td>
