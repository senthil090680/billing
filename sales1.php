...
<script type="text/javascript" src="js/autocomplete_item1.js"></script> <!-- Drop Down List Holding File -->
...
<script type="text/javascript" src="js/autoitemsearch3.js"></script> <!-- For enter key selection and mouse click event of item name drop down list. -->
