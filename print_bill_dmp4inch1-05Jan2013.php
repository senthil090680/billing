...
<script type="text/javascript">
      ...
      function funcPrint() {
         ...
         if (applet != null) {
			...
			<?php
			$serialnumber = "";
			$query4 = "select * from sales_details where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' and financialyear = '$financialyear'";
			...
			?>
			<?php
			$query41 = "select *, sum(taxamount) as sumtaxamount from sales_tax  where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' and financialyear = '$financialyear' group by tax_autonumber"; 
