  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="1010" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="944" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
            ...
            <tr>
              ...
              <td width="24%" align="left" valign="top" ><select name="taxtype" id="taxtype">
                ...
                <td width="8%" align="left" valign="center"  class="bodytext31"> Date From </td>
                ...
                <td width="8%" align="left" valign="center"  class="bodytext31"> Date To </td>
                <td width="13%" align="left" valign="center"  bgcolor="#ffffff"><span class="bodytext31">
                ...
                <td width="20%" colspan="2" align="left" valign="center"  class="bodytext31"><input type="hidden" name="cbfrmflag12" value="cbfrmflag1">
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
			  ...
			  ?>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><strong>TaxTotal</strong></td>
              <td class="bodytext31" valign="center"  align="left" 
			...
			where itemtaxpercentage = '$res4taxpercent' and companyanum = '$companyanum' and recordstatus <> 'deleted'  
			...
			$query3 = "select * from master_purchase where auto_number = '$billautonumber' and billdate between '$transactiondatefrom' and '$transactiondateto'";
