        ...
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
			  ...
			  <tr>
				...
				if ($itemcode != '')
				{
				$query43 = "select * from master_item where itemcode = '$itemcode'";
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				//include ('productionrequest_edit1listing1.php');
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
			  ...
			  <input type="text" name="itemserialnumber" id="itemserialnumber" style="border: 1px solid #001E6A; text-align:left" value="1" size="1" readonly="readonly" /></td>
