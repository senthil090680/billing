...
<script type="text/javascript">
      ...
      function funcPrint() {
         ...
         if (applet != null) {
			...
			<?php
			$serialnumber = "";
			$query4 = "select * from purchasereturn_details where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum'";
			...
			?>
			<?php
			$query41 = "select *, sum(taxamount) as sumtaxamount from purchasereturn_tax  where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' group by tax_autonumber"; 
