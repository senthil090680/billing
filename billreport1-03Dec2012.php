...
<table width="1460" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="1%" valign="top"><?php //include ("includes/menu4.php"); ?>
      &nbsp;</td>
    <td width="99%" valign="top"><table width="1424" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1424">
...
-->			  
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  ?>
            <tr>
              <td colspan="21" bgcolor="#FFFF00" class="bodytext31">&nbsp;<?php echo $errmsg1; ?></td>
              </tr>
			<?php
			}
			?>	
            ...
            <tr>
			  ...
			  <?php
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
					...
					$urlpath = "cbcustomername=$cbcustomername&&cbbillnumber=$cbbillnumber&&approvalstatus=$approvalstatus&&paymenttype=$paymenttype&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&companyanum=$companyanum&&companyname=$companyname&&username=$username&&financialyear=$financialyear";
				}
				else
				{
					$urlpath = "cbcustomername=$cbcustomername&&cbbillnumber=$cbbillnumber&&approvalstatus=APPROVED&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&companyanum=$companyanum&&companyname=$companyname&&username=$username&&financialyear=$financialyear";
				}
				?>
 				<?php
