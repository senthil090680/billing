...
$query1 = "select * from master_transaction where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
...
if ($receiptanum != '')
{
	$query21 = "select * from master_transaction where auto_number = '$receiptanum'";
}
else
{
	$query21 = "select * from master_transaction where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
}
