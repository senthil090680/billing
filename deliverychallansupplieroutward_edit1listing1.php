...
{
//echo 'inside if';
$query41 = "select * from dcsupplieroutward_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
$query42 = "select * from dcsupplieroutward_tax where itemcode = '$varItemCode' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
