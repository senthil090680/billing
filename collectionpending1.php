...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" /></td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="center"><strong>View</strong></div></td>
			...
			*/
            ...
            align="left" border="0">
              <tbody>
                ...
                bgcolor="#ffffff" class="bodytext311"><strong> Customer </strong></td>
                ...
                bgcolor="#ffffff" class="bodytext311"><div align="right"><strong>Collected</strong></div></td>
                  <td width="9%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Last Collection </strong></div></td>
                  <td width="11%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong> After Collection </strong></div></td>
                  <td width="7%" align="left" valign="center" bordercolor="#f3f3f3" 
			...
			$subTRquery21 = "select * from master_sales where customercode = '$res4customercode' and recordstatus <> 'deleted' and companyanum = '$companyanum';";
			...
			while ($subTRres21 = mysql_fetch_array($subTRexec21))
			{
				...
				$subTRquery3 = "select * from master_transaction where transactiontype = 'COLLECTION' and transactionmode <> 'CREDIT' and billnumber = '$subTRbillnumber' and companyanum='$companyanum' and recordstatus = ''";
				...
				$subTRquery3 = "select * from master_transaction where transactiontype = 'COLLECTION' and transactionmode <> 'CREDIT' and billnumber = '$subTRbillnumber' and companyanum='$companyanum' and recordstatus = '' order by auto_number desc";
				$subTRexec3 = mysql_query($subTRquery3) or die ("Error in Query3".mysql_error());
			...
			?>
                <tr <?php echo $subTRcolorcode; ?>>
                  ...
                  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"><div class="bodytext311"> <?php echo $subTRcustomername; ?></div></td>
                  ...
                  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"><div align="right"> <?php echo $subTRbilldate; ?></div></td>
                  ...
                  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"><div align="right">
                      <?php if ($subTRnetcollection != '0.00') echo $subTRnetcollection; //echo number_format($subTRnetcollection, 2); ?>
                  </div></td>
                  <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"><div align="right"> <?php echo $subTRlastcollectiondate; ?> </div>
                      <div align="right"></div>
                    <div align="right"></div></td>
                  <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"><div align="right">
                      <?php if ($subTRdaysaftercollectiondate != '') echo $subTRdaysaftercollectiondate.' Days'; ?>
                    </div>
                      <div align="right"></div>
                    <div align="right"></div></td>
                  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"><div align="right">
			...
			?>
                ...
                bgcolor="#cccccc">&nbsp;</td>
                  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo number_format($subTRtotalbalance, 2, '.', ''); ?></strong></div></td>
                </tr>
              </tbody>
            </table>
