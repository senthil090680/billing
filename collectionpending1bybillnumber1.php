      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query2 = "select * from master_sales where customername like '%$customername%' and financialyear = '$financialyear' and recordstatus <> 'deleted' and companyanum = '$companyanum';";
			...
			while ($res2 = mysql_fetch_array($exec2))
			{
				...
				$query3 = "select * from master_transaction where transactiontype = 'COLLECTION' and transactionmode <> 'CREDIT' and billnumber = '$billnumber' and financialyear = '$financialyear' and companyanum='$companyanum' and recordstatus = ''";
			...
			$balanceamount = number_format($balanceamount, 2, '.', '');
				...
				$query3 = "select * from master_transaction where transactiontype = 'COLLECTION' and transactionmode <> 'CREDIT' and billnumber = '$billnumber' and financialyear = '$financialyear' and companyanum='$companyanum' and recordstatus = '' order by auto_number desc";
				$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
