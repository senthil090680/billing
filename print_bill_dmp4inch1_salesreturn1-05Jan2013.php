...
<script type="text/javascript">
      ...
      function funcPrint() {
         ...
         if (applet != null) {
			...
			<?php
			$serialnumber = "";
			$query4 = "select * from salesreturn_details where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum'";
			...
			?>
            applet.append("<?php echo $footerline2split3; ?>\n");
            <?php
			}
			?>
			<?php
			$query41 = "select *, sum(taxamount) as sumtaxamount from salesreturn_tax  where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' group by tax_autonumber"; 
