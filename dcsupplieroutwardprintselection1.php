...
function loadprintpage1()
{
	...
	if (varTitleHeader != 'ALL')
	{
		...
		{
			window.open("print_bill1_deliverychallansupplier1outward.php?printsource=printselectionpage&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo rand(); //$banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
		if (varPaperSize == "A5 Sheet Paper")
		{
			window.open("print_bill1_deliverychallansupplier1outward_a5.php?printsource=printselectionpage&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo rand(); //$banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
	}
	else
	{
		...
		if (varPaperSize == "A4 Sheet Paper")
		{
			window.open("print_bill1_deliverychallansupplier1outward.php?printsource=printselectionpage&&title1=<?php echo $billtitleheader11; ?>&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo $masanum11; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
		if (varPaperSize == "A5 Sheet Paper")
		{
			window.open("print_bill1_deliverychallansupplier1outward_a5.php?printsource=printselectionpage&&title1=<?php echo $billtitleheader11; ?>&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo $masanum11; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
		<?php
		}
		?>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="90%" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>DC Supplier Outward Bill Print </strong></td>
