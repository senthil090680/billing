    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="leadassignedtoreport1.php">
		<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lead Assigned To Report</strong></td>
...
-->
			...
			if (isset($_REQUEST["leadassignedto"])) { $leadassignedto = $_REQUEST["leadassignedto"]; } else { $leadassignedto = ""; }

		  $query2 = "select * from master_leads where customername like '%$customername%' and leadassignedto like '%$leadassignedto%' and recordstatus <> 'DELETED' and leaddate between '$leaddatefrom' and '$leaddateto' order by leaddate desc";
