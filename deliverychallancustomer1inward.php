...
$query88 = "select count(auto_number) as cntanum from master_dccustomerinward";// where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		//$query19 = "select auto_number,lastupdate from master_dccustomerinward where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query19 = "select auto_number,lastupdate from master_dccustomerinward where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			//$query15 = "update master_dccustomerinward set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$query15 = "update master_dccustomerinward set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			//$query16 = "update dccustomerinward_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query16 = "update dccustomerinward_details set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			//$query17 = "update dccustomerinward_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query17 = "update dccustomerinward_tax set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			...
			*/
			$query20="update master_stock set recordstatus='DELETED' where transactionmodule = 'DC CUSTOMER INWARD' and billnumber = '$delbillnumber' and companyanum = '$companyanum'";
...
include ("deliverychallancustomer1inwardinclude1.php"); //handles all the sales insert operations
...
if ($delbillst == 'billedit' && $delbillnumber != '')
{
	$query41 = "select * from master_dccustomerinward where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
function loadprintpage1(varPaperSizeCatch)
{
	...
	if (varPaperSize == "A4")
	{
		window.open("print_bill1_deliverychallancustomer1inward.php?printsource=billpage&&billautonumber="+varBillAutoNumber+"&&companyanum="+varBillCompanyAnum+"&&title1="+varTitleHeader+"&&billnumber="+varBillNumber+"","OriginalWindow<?php echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	}
	if (varPaperSize == "A5")
	{
		window.open("print_bill1_deliverychallancustomer1inward_a5.php?printsource=billpage&&billautonumber="+varBillAutoNumber+"&&companyanum="+varBillCompanyAnum+"&&title1="+varTitleHeader+"&&billnumber="+varBillNumber+"","OriginalWindow<?php echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	}
...
<form name="frmsales" id="frmsales" method="post" action="deliverychallancustomer1inward.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>DC Inward Customer   </strong></td>
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Prefix
				  ...
				  //No to allow bill number change.
				  $billnumbertextboxvalidation = 'readonly="readonly"';
				  ?>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('deliverychallancustomerinward_edit1listing1.php');
...
bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
				...
				<select name="billtype" id="billtype" onChange="return paymentinfo()">
					...
					<option value="DC">DC CUSTOMER IN</option>
                    <!--
