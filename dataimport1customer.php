...
if ($frmflag1 == 'frmflag1')
{
	...
	$final_filename=$username."_tabdumpcustomer.txt";
	...
	if ($fileformat == 'txt') // || $fileformat == 'peg') // || $fileformat == 'gif')
	{
		...
		{
			header ("location:dataimport2customer.php?upload=success");
		}
		else
		{
			header ("location:dataimport1customer.php?upload=failed");
		}
...
function dataimport1customerverify()
{
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form action="dataimport1customer.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return dataimport1customerverify()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><a href="tab_file_dump/sample_import_file1customer.xls" class="bodytext3"><span class="bodytext3"><strong>Sample Download File Click Here...</strong></span></a></td>
