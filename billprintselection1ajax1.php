...
$query5 = "TRUNCATE TABLE sales_print_dump";
$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());

$query3 = "select * from master_sales where billnumber = '$billnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'DELETED'";
...
$query4 = "select * from sales_details where bill_autonumber = '$res3anum' and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear' order by auto_number";
...
while ($res4 = mysql_fetch_array($exec4))
{
	...
	$query6 = "insert into sales_print_dump (serialnumber, bill_autonumber, companyanum, 
	...
	for ($i=0;$i<$itemdescriptionarraycount;$i++)
	{
		...
		//echo '<br><br>'.
		$query7 = "insert into sales_print_dump (bill_autonumber, companyanum, itemdescription, financialyear) 
