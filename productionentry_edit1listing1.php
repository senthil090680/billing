...
{
//echo 'inside if';
$query41 = "select * from production_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";// and financialyear = '$financialyear'";
...
$query42 = "select * from production_tax where itemcode = '$varItemCode' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";// and financialyear = '$financialyear'";
...
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input name="discountpercent<?php echo $itemcount; ?>" value="<?php echo $varItemDiscountPercent; ?>" type="hidden" id="discountpercent<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="2" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input name="discountrupees<?php echo $itemcount; ?>" value="<?php echo $varItemDiscountRupees; ?>" type="hidden" id="discountrupees<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="2" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
