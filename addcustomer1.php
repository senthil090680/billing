...
if ($frmflag1 == 'frmflag1')
{
	...
	$typeofcustomer=$_REQUEST["typeofcustomer"];
	...
	if ($res2 == 0)
	{
		...
		header("location:addcustomer1.php?st=success");
		//header ("location:addcompany1.php?st=success&&cpynum=1");
	}
	else
	{
		header ("location:addcustomer1.php?st=failed");
	}
...
{
	$errmsg = "Please Add Customer To Proceed For Billing.";
	$bgcolorcode = 'failed';
}
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" onKeyDown="return disableEnterKey()" action="addcustomer1.php" onSubmit="return process1()">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="800" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>Customer - New </strong></td>
              ...
              <!--<tr>
				...
				<input name="customername" id="customername" value="<?php echo $companyname; ?>" style="border: 1px solid #001E6A;" size="60"></td>
                </tr>
			  <tr>
...
-->				   </td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="mobilenumber" id="mobilenumber" value="<?php echo $faxnumber2; ?>" style="border: 1px solid #001E6A;"  size="20" />
