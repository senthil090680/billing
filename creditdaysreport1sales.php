...
$transactiondatefrom = date('Y-m-d', strtotime('-3 month'));
...
function loadprintpage2(banum)
{
	...
	//window.open("print_bill1_sales1.php?banum="+varbanum+"","Window2"Original"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
...
function loadpdfpage1(banum)
{
	...
	//window.open("print_bill1_sales1.php?banum="+varbanum+"","Window"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
}

function funcRedirectWindow1()
{
	window.location = "creditdaysreport1sales.php";
}
...
function funcDeleteRecord1(varBillNumberNumber)
{
	...
	var fRet;
	fRet = confirm('Are You Sure Want To Delete This Credit Reminder For Bill Number '+varBillNumberNumber+'?');
	//alert(fRet);
	if (fRet == true)
	{
		var fRet2;
		fRet2 = confirm('You Cannot Reverse This. Are Sure Your Want To Delete This Credit Reminder For Bill Number '+varBillNumberNumber+'?');
		//alert(fRet);
		if (fRet2 == true)
		{
			alert ("Success. Credit Reminder Delete Completed.");
			//return false;
		}
		if (fRet2 == false)
		{
			alert ("Failed. Credit Reminder Delete Not Completed.");
			return false;
		}
	}
	if (fRet == false)
...
<table width="1100" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="99%" valign="top"><table width="1075" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
		
              <form name="cbform1" method="get" action="creditdaysreport1sales.php">
		<table width="867" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Credit Days Report - Sales Bill</strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  <?php
			...
			if ($task == 'deleted')
			{
			$errmsg1 =  'Success. Selected Credit Reminder Delete Completed.';
		  ?>
            <tr>
...
&nbsp;				<!--<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->			</td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ffffff"><div align="center"><strong>Credit Days</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ffffff"><div align="center"><strong>Days Elapsed</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ffffff"><div align="center"><strong>Days Remaining</strong></div></td>
              <!--<td class="bodytext31" valign="center" align="left" 
                bgcolor="#ffffff"><strong>Delivery</strong></td>-->
              <td width="6%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Due Date </strong></div></td>
			...
			*/
			...
			$query2 = "select * from master_sales where customername like '%$customername%' and 
			billnumber like '%$cbbillnumber%' and $billstatusquery1 and billtype like '%$paymenttype%' and 
			companyanum = '$companyanum' and creditdaysstatus <> 'COMPLETED' and 
			billdate between '$transactiondatefrom' and '$transactiondateto' order by lastupdate desc";
			...
			$creditdays = $res2['creditdays'];
			//$creditdays = 5; //Test Value.

			$creditduedate = $billdate;
			$creditduedate = substr($creditduedate, 0, 10);
			$dotarray = explode("-", $creditduedate);
			$dotyear = $dotarray[0];
			$dotmonth = $dotarray[1];
			$dotday = $dotarray[2];
			//$creditduedate = date("Y-m-d", mktime(0, 0, 0, $dotmonth, $dotday + 1, $dotyear));
			$creditduedate = date("Y-m-d", mktime(0, 0, 0, $dotmonth, $dotday + $creditdays, $dotyear));

			$dayselapsed = round( abs( strtotime(date('Y-m-d')) - strtotime($billdate) ) / 86400, 0 );
			//echo $dayselapsed;
			
			$daysremaining = $creditdays - $dayselapsed;
			//echo $daysremaining;
	
			//$colorloopcount = $colorloopcount + 1;
			//$showcolor = ($colorloopcount & 1); 
			//if ($showcolor == 0)
			if ($dayselapsed > $creditdays)
			{
				//echo "if";
				//$colorcode = 'bgcolor="#CBDBFA"';
				$colorcode = 'bgcolor="#FFA448"';
			}
			else
			{
				//echo "else";
				//$colorcode = 'bgcolor="#D3EEB7"';
				$colorcode = 'bgcolor="#66FF33"';
			}
			...
			$dotmonth = $dotarray[1];
			$dotday = $dotarray[2];
			$creditduedate = strtoupper(date("d-M-Y", mktime(0, 0, 0, $dotmonth, $dotday, $dotyear)));
			...
			?>
              ...
              <td class="bodytext31" valign="center" align="left"><div align="right"> 
			  <?php echo $creditdays; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center" align="left"><div align="right"> 
			  <?php echo $dayselapsed; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center" align="left"><div align="right"> 
			  <?php echo $daysremaining; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center" align="left"> 
                <div align="center"><?php echo $creditduedate; ?></div></td>
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="creditdaysdelete1sales.php?task=delete&&anum=<?php echo $billautonumber; ?>" 
