...
if ($frmflag1 == 'frmflag1')
{
	...
	$query3 = "select auto_number from settings_bill where companyanum = '$companyanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
	$rowcount3 = mysql_num_rows($exec3);
	if ($rowcount3 != 0)
	{
		$query1 = "update settings_bill set f1 = '$f1', f2 = '$f2', f3 = '$f3', f4 = '$f4', f5 = '$f5', 
	...
	{
		$query4 = "insert into settings_bill (f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, 
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" action="settingsbill1.php" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <table width="900" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Settings - Sales Bill </strong></td>
