...
//$checkfile = $foldername.'/CustomerList.xls';
...
$data .= "Customer".$tab."Location" . $tab . "City" . $tab . "Phone1" . $tab . "Phone2" . $tab."Email1". $tab . "Email2" . $tab . "Fax1" . $tab . "Fax2" . $tab . "Address1". $tab . "Address2". $tab . $cr;
...
$fp = fopen($foldername.'/CustomerList.xls', 'w+');
fwrite($fp, $data);
fclose($fp);
...
function process1()
{
	...
	{
		//alert("Please Enter Any Starting Letter Or Search Key Words In Customer Name To Search.");
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<form name="form1" id="form1" method="get" action="searchcustomer1.php" onSubmit="return process1()">
            ...
            <tbody>
              <tr bgcolor="#011e6a">
                <td class="bodytext31" bgcolor="#cccccc" 
                  colspan="2"><strong>Customer   List </strong></td>
              </tr>
              <tr>
                <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#FFFFFF">Search Customer </td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody>
              ...
              <tr>
				...
				function excelexport1()
				{
					...
					window.location = "dbexcelfiles/CustomerList.xls"
				}
				</script>&nbsp;</td>
                <td align="left" valign="center"  
			...
			else
			{
              ...
              <tr <?php echo $colorcode; ?>>
                ...
                <td class="bodytext31" valign="center"  align="left">
				<div align="center"><a href="editcustomer1.php?customercode=<?php echo $res2customercode; ?>" class="bodytext3"><span class="bodytext3">Edit</span></a></div></td>
                <td class="bodytext31" valign="center"  align="left">
