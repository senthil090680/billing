											...
											else
											{
												...
												else
												{
													...
													else
													{
														...
														$query2 = "update master_supplier set suppliername = '$suppliername', address1 = '$address1', address2 = '$address2', 
														area = '$area', city = '$city', state = '$state', pincode = '$pincode' where suppliercode = '$suppliercode'";
              ...
              <td><table width="83%" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top" bgcolor="#FFFFFF" ><?php echo $skipcountsuppliercode; ?> <span class="bodytext3">( Please Check The Supplier Code Exists In The Supplier Masters ) </span></td>
                  </tr>
                  <tr>
