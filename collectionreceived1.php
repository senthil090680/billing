...
function funcPrintReceipt1(varRecAnum)
{
	...
	window.open("print_collection_receipt1.php?receiptanum="+varRecAnum+"","OriginalWindow<?php //echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
}
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="collectionreceived1.php">
		<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Collection Received Report     - Select Customer </strong></td>
              <!--<td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><?php echo $errmgs; ?>&nbsp;</td>-->
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td width="21%"  align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Select Customer </td>
          ...
          <tbody>
            <tr>
              ...
              <?php
				...
				$filename1 = "print_collectionreceivedreport1.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/CollectionReceivedByCustomer.xls', 'w+');
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
		  ...
		  $query2 = "select * from master_transaction where customername like '%$cbcustomername%' and financialyear = '$financialyear' and recordstatus <> 'DELETED' and supplieranum = '0' and suppliername = '' and companyanum = '$companyanum' and transactiondate between '$paymentreceiveddatefrom' and '$paymentreceiveddateto' and transactiontype = 'COLLECTION' order by transactiondate desc";
