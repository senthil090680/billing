    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="leadmarketingsourcereport1.php">
		<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lead Marketing Source Report</strong></td>
...
-->
		...
		if (isset($_REQUEST["leadsourcename"])) { $leadsourcename = $_REQUEST["leadsourcename"]; } else { $leadsourcename = ""; }
			
		  $query2 = "select * from master_leads where customername like '%$customername%' and leadsourcename like '%$leadsourcename%' and recordstatus <> 'DELETED' and leaddate between '$leaddatefrom' and '$leaddateto' order by leaddate desc";
