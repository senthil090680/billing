...
AutoSuggestControl1.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			//alert ("Mouse Down."); 
			//alert ("1");
			categoryitemsearch(); //Function located at the bottom of this file.		
			//alert ("2");
			//itemcodeentry1() //Function from itemcodeentry1.js.		
			//alert ("3");
...
function servicelostfocus(sernum)
{
		//alert ("you pressed a key.");
		var sernum = sernum; 
		//document.getElementById("rateperunit"+sernum).focus();
		
		categoryitemsearch(sernum) //Function from js/autocomplete_itemsearch2.js
		
		//document.getElementById("itemcode"+sernum).focus();
		return false;
