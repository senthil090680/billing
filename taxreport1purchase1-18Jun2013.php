...
$res2loopcount = '';
$showtaxonlytotal = '';
$showfinaltaxonlytotalamount = '';
$showfinaltotalitemamount = '';
          ...
          <tbody>
            <tr>
              ...
              <td colspan="7" bgcolor="#cccccc" class="bodytext31">
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
					...
					$urlpath = "cbfrmflag1=cbfrmflag1&&taxtype=$taxtype&&transactiondatefrom=$transactiondatefrom&&transactiondateto=$transactiondateto&&companyanum=$companyanum";//&&companyname=$companyname";
				}
				else
				{
					$urlpath = "cbfrmflag1=cbfrmflag1&&taxtype=&&transactiondatefrom=$transactiondatefrom&&transactiondateto=$transactiondateto&&companyanum=$companyanum";//&&companyname=$companyname";
				}
				?>
 				<?php
				...
				$filename1 = "print_taxreport1purchase1.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/TaxPurchaseReport.xls', 'w+');
				...
				{
					window.open("print_taxreport1purchase1.php?<?php echo $urlpath; ?>","Window1",'width=900,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/TaxPurchaseReport.xls"
				}
				</script>
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  */
			  ...
			  ?>
				<td class="bodytext31" valign="center"  align="left">
				<div align="right"><?php echo $totalitemamount; ?></div></td>
			  <td class="bodytext31" valign="center"  align="left"><div align="right"> 
			  <?php echo $totaltaxamount; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="right"> 
            ...
            <tr>
			  ...
			  <td class="bodytext31" valign="center"  align="left" 
				...
				<td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong> <?php echo $showfinaltotalitemamount; ?>&nbsp;</strong></div></td>
				<td class="bodytext31" valign="center"  align="left" 
				bgcolor="#cccccc"><div align="right"><strong> <?php echo $showfinaltaxonlytotalamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
