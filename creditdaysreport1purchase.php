...
{
	window.location = "creditdaysreport1purchase.php";
}
    ...
    <td width="99%" valign="top"><table width="1075" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="get" action="creditdaysreport1purchase.php">
		<table width="867" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Credit Days Report - Purchase Bill</strong></td>
			...
			*/
			...
			?>
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="creditdaysdelete1purchase.php?task=delete&&anum=<?php echo $billautonumber; ?>" 
