            ...
            align="left" border="0">
                ...
                bgcolor="#E0E0E0" class="bodytext31">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td class="bodytext31" valign="center"  align="left" bgcolor="#E0E0E0">
					<input name="rateperunit" value="0.00" id="rateperunit" onKeyDown="return disableEnterKey()" onBlur="return quantityvalidation()" style="border: 1px solid #001E6A; text-align:right" size="8" /></td>
                    <td class="bodytext31" valign="center"  align="left" bgcolor="#E0E0E0">
					<input name="quantity" value="1" id="quantity"  onKeyDown="return btnClick()" onBlur="return quantityvalidation()" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
...
-->					
            ...
            align="left" border="0">
				...
				bgcolor="#E0E0E0" class="bodytext31"><!-- To avaoid duplicates, parent tax anum is joined. see javascript also. -->
                         <input name="totaltaxsubamount<?php echo $res5anum; ?><?php echo $res6loopcount; ?>" id="totaltaxsubamount<?php echo $res6loopcount; ?>" value="0.00" style="border: 1px solid #001E6A; text-align:right" onKeyDown="return disableEnterKey()" size="8"  readonly="readonly" /></td>
				     </tr>
				<?php
				}
				}
