...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($fileformat == 'txt') // || $fileformat == 'peg') // || $fileformat == 'gif')
	{
		...
		{
			header ("location:dataimport2supplier.php?upload=success");
		}
		else
		{
			header ("location:dataimport1supplier.php?upload=failed");
		}
...
function dataimport1supplierverify()
{
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form action="dataimport1supplier.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return dataimport1supplierverify()">
