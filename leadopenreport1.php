    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="leadopenreport1.php">
		<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lead Pending Report</strong></td>
...
-->
            ...
            <tr>
              ...
              <td width="3%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Update</strong></div></td>
              <td width="3%" align="left" valign="center"  
		  ...
		  $query2 = "select * from master_leads where customername like '%$customername%' and leadstatusname = 'OPEN' and recordstatus <> 'DELETED' and leaddate between '$leaddatefrom' and '$leaddateto' order by leaddate desc";
		  ...
		  while ($res2 = mysql_fetch_array($exec2))
		  {
           ...
           <tr <?php echo $colorcode; ?>>
			 ...
			 <a href="#" class="bodytext31" onClick="return funcLeadUpdate1('<?php echo $leadanum; ?>')">Update</a>
			 </div></td>
             <td class="bodytext31" valign="center"  align="left">
			 <div align="center">
			 <a href="#" class="bodytext31" onClick="return funcLeadPrint1('<?php echo $leadanum; ?>')">Print</a>
			 </div>			 </td>
              <td class="bodytext31" valign="center"  align="left">
