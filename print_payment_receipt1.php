...
$query1 = "select * from master_transaction where transactiontype = 'PAYMENT' and transactionmodule = 'PAYMENT' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
...
{
	$query21 = "select * from master_transaction where transactiontype = 'PAYMENT' and transactionmodule = 'PAYMENT' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
}
