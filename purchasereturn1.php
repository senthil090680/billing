        ...
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            ...
            <tr>
              ...
              <td width="37%" align="left" valign="top" ><input name="supplier" id="supplier" value="<?php echo $res41suppliername; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40" autocomplete="off"/>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
              ...
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1()" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1()" onBlur="return itemtotalamountupdate1()" name="itemdiscountrupees" value="0.00" id="itemdiscountrupees" style="border: 1px solid #001E6A; text-align:right" size="3" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
              <input onKeyDown="return itemquantitykeypress1()" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="2" />
...
-->
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="36%"><span class="bodytext312">
