...
{
//echo 'inside if';
$query41 = "select * from sales_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";
...
$query42 = "select * from sales_tax where itemcode = '$varItemCode' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";
