...
//{
	...
	if ($printsource == '')
	{
		...
		$query22 = "select * from master_salesreturn where auto_number = '$billautonumber' and companyanum = '$companyanum'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_salesreturn where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_salesreturn where billnumber = ".$_REQUEST['billnumber']." and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
	}
...
$query21 = "select auto_number from master_salesreturn where auto_number = '$res22anum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec21 = mysql_query($query21) or die ("Error in Query21".mysql_error());
$res21 = mysql_fetch_array($exec21);
$res21anum = $res21['auto_number'];

$query3 = "select * from master_salesreturn where auto_number = '$res21anum' and companyanum = '$companyanum'";
...
$discountexists = "";
$query4 = "select * from salesreturn_details where bill_autonumber = '$billautonumber' and companyanum = '$companyanum'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
  ...
  <tr>
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      ...
      <thead>
		...
		$query9 = "select * from salesreturn_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum'";
		...
		$query5 = "select * from master_salesreturn where auto_number = '$res21anum'";
		$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		$res5 = mysql_fetch_array($exec5);
     ...
     <tr>
      ...
      <?php
		//$subtotalaftertax = $subtotalafterdiscountamount;
	  	...
	  	$query6 = "select *, sum(taxamount) as sumtaxamount from salesreturn_tax where bill_autonumber = '$billautonumber' and recordstatus <> 'DELETED' group by tax_autonumber, taxname order by auto_number";
		$exec6 = mysql_query($query6) or die ("Error in Query6".mysql_error());
